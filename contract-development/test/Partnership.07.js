...
describe("Partnership", () => {
  it(`can be deployed by providing at least two addresses
and equal amounts of split ratios on initialization`, async () => {
  ...
  it(`can NOT be deployed when the split ratios
are not equivalent to the address amount`, async () => {
    const Contract = await hre.ethers.getContractFactory(
      "Partnership07"
    );
  ...
  it(`can NOT be deployed when
the address amount is less than two`, async () => {
    const Contract = await hre.ethers.getContractFactory(
      "Partnership07"
    );
  ...
  it(`can NOT be deployed when 
any of the split ratios is less than one`, async () => {
    const Contract = await hre.ethers.getContractFactory(
      "Partnership07"
    );
  ...
  it(`has a balance that increases
after receiving a transaction`, async () => {
    const Contract = await ethers.getContractFactory(
      "Partnership07"
    );
